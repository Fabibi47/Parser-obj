...
Contains an Parser for .obj and .mtl files along with shader calculating shadow with a point light.
Also supports Directional and Spot lights but the shadows won't follow (this will be added hopefully).
